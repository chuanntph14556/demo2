...
var db = 'mongodb+srv://admin:chuantai72446@cluster0.wg9fr.mongodb.net/student?retryWrites=true&w=majority'
...
var dbb = 'mongodb+srv://admin:chuantai72446@cluster0.0d1qy.mongodb.net/mydata?retryWrites=true&w=majority'
...
var upload1 = multer1({
  storage: storage1, limits: {
    fileSize: 2*1024*1024 // giới hạn file up lên là 2MB
  }
}).single('avatar');
